...
public class ShoppingSteps {
   ...
   public void iShouldNavigateToShoppingCartPage() throws InterruptedException {
    ...
    public void iClickOnCreditCardPaymentOption() throws InterruptedException {
        new CheckOutPage().clickOnCreditCard();
        new CheckOutPage().clickOnPaymentContinue();
    }

    @And("^I click on credit card type as Master Card$")
    public void iClickOnCreditCardTypeAsMasterCard() throws InterruptedException {
    ...
    @Then("^I verify the credit card payment method$")
    public void iVerifyTheCreditCardPaymentMethod() throws InterruptedException {
        String expectedMessage = "Credit Card";
        String actualMessage = new CheckOutPage().getPaymentTypeText();
        Assert.assertEquals(expectedMessage, actualMessage, "Unable to checkout");
    }

    @Then("^I verify the next day air delivery method$")
    public void iVerifyTheNextDayAirDeliveryMethod() throws InterruptedException {
